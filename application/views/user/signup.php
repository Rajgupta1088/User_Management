  ...
  <div class="container">
      ...
      <div class="form-row">
        <div class="col-md-6">
          <div class="form-label-group">
            ...
            <?= form_input(['name' => 'firstname', 'id' => 'firstname', 'class' => 'form-control', 'autofocus' => 'autofocus', 'value' => set_value('firstname')]); ?>
        ...
        <div class="col-md-6">
          <div class="form-label-group">
            ...
            <?= form_input(['name' => 'lastname', 'id' => 'lastname', 'class' => 'form-control', 'autofocus' => 'autofocus', 'value' => set_value('lastname')]); ?>
    ...
    <div class="form-group">
      <div class="form-label-group">
        ...
        <?= form_input(['name' => 'mobilenumber', 'id' => 'mobilenumber', 'class' => 'form-control', 'autofocus' => 'autofocus', 'value' => set_value('mobilenumber')]); ?>
    ...
    <?= form_submit(['name' => 'Register', 'value' => 'Register', 'class' => 'btn btn-primary btn-block']); ?>

    </form>
    <div class="text-center">
      <a class="d-block small mt-3" href="<?= site_url('user/Login'); ?>">Login Page</a>
